    ...
    <div style={{ fontFamily: "var(--body)", color: "var(--ink)", overflowX: "hidden" }}>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .nav{position:fixed;top:0;left:0;right:0;z-index:10000;height:120px;padding:0 64px;display:flex;align-items:center;justify-content:space-between;transition:background .35s,box-shadow .35s;background:rgba(255,255,255,0);}
        ...
        .hero-inner{position:relative;z-index:2;width:100%;padding:160px 80px 100px;display:grid;grid-template-columns:1.3fr 1fr;gap:72px;align-items:center;}
